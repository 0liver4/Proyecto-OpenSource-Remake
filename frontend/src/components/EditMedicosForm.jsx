...
const EditMedicosForm = ({ medicos, onClose, onSuccess, isOpen }) => {
    ...
    useEffect(() => {
        if (medicos) {
            setFormData({
                ...
                nommedico: medicos.nommedico || '',
                cedulamedico: medicos.cedulamedico || '',
                tandalaboral: medicos.tandalaboral || '',
                especialidad: medicos.especialidad || '',
                estado: medicos.estado?.toString() || 'true'
            });
        }
    }, [medicos]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const success = await EditSup(formData, "medicos", "id_medico");
            if (success) {
                onSuccess();
                onClose();
            } else {
...
export default EditMedicosForm;